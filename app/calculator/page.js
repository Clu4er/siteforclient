...
export const metadata = buildMetadata({
  title: "Калькулятор криптокотла: мощность, тариф и итог в рублях",
  description:
    "Калькулятор отопления на базе майнинга: хешрейт, актуальный курс BTC через CoinGecko, мощность, стоимость электричества, полезное тепло и ориентир по результату в рублях.",
  path: "/calculator",
  keywords: [
    "калькулятор криптокотла",
    "калькулятор майнинг отопления",
    "курс BTC электричество калькулятор",
  ],
});
...
const calculatorBenefits = [
  {
    ...
    text: "В расчёте остаются только понятные вводные: хешрейт, мощность, стоимость кВт·ч и итог в рублях. Курсы подтягиваются автоматически.",
  },
  {
...
const relatedLinks = [
  ...
  {
    href: "/engineering",
    title: "Инженерия подключения",
    text: "После быстрого расчёта можно перейти к схеме: контуры, автоматика, резерв и интеграция в объект.",
  },
];
    ...
    <MarketingShell content={content}>
      ...
      <JsonLd
        data={createServiceSchema({
          ...
          description:
            "Расчёт сценария криптокотла по хешрейту, курсу BTC, мощности, тарифу и полезному теплу.",
          path: "/calculator",
        ...
        <section className="page-hero">
          <div className="shell">
            ...
            <div className="page-hero__copy page-hero__copy--wide">
              ...
              <h1>
                Калькулятор <span className="text-highlight">криптокотла</span>{" "}
                с итогом в рублях
              </h1>
              <p>
                Введите основные параметры и получите первый ориентир по сценарию:
                хешрейт, автоматический курс BTC, мощность, стоимость электричества,
                полезное тепло и примерный итог в рублях.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          <div className="shell">
            <SectionHeading
              ...
              description="Можно перейти к домашнему, бизнес- или инженерному сценарию, а если объект уже топится от сети — сравнить криптокотёл с электрическим отоплением."
            />
        ...
        <section className="section">
          <div className="shell">
            <PageCta
              ...
              text="Свяжитесь с нами. Мы расширим быстрый калькулятор до инженерного сценария с учётом контуров, автоматики, сезонности и роли оборудования в общей системе."
