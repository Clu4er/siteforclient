...
export const metadata = {
  ...
  description:
    "ООО ТД «Саратовская Подшипниковая Корпорация»: поставка российских и импортных подшипников, складской комплекс, входной контроль качества, подбор аналогов.",
  alternates: {
...
const valueCards = [
  ...
  },
  {
    ...
    text: "Политика СПК нацелена на стабильные поставки, понятные сроки и взаимовыгодное сотрудничество.",
  },
];
            ...
            <div>
              ...
              <div className="bearings-copy">
                <p>
                  ...
                  работы на рынке подшипниковой продукции. Широкий ассортимент,
                  гибкая система скидок, квалифицированный персонал и внимательная
                  работа с заявками позволяют выстраивать долгосрочные отношения с
                  покупателями.
                </p>
                <p>
                  На собственной территории расположен административно-складской
                  комплекс. Входной контроль продукции помогает гарантировать, что
                  заказчик получает товар без пересортицы, недопоставки и лишних
                  задержек.
                </p>
              </div>
            </div>
        ...
        <section className="section" id="partners">
          <div className="shell split-section">
            <div>
              <SectionHeading
                eyebrow="Партнёрам"
                title="Политика компании нацелена на долгосрочное сотрудничество"
                description="Максимально полное удовлетворение потребностей клиентов является основным принципом работы компании."
              />
            </div>
