  ...
  return (
    <MarketingShell content={content}>
      ...
      <main>
        ...
        <section className="section">
          <div className="shell">
            <UseCasesGallery variant="private" />
          </div>
        </section>
        ...
        <section className="section">
          <div className="shell">
            <PageCta
              ...
              text="Свяжитесь с нами. Мы разложим домашний сценарий по существующему отоплению, тарифу, полезному теплу и возможной роли криптокотла в системе."
