        ...
        <section className="page-hero">
          <div className="shell">
            ...
            <div className="page-hero__grid">
              ...
              <div className="page-hero__media page-hero__media--portrait">
                <Image
                  src={mediaAssets.engineeringIntegration.src}
                  alt={mediaAssets.engineeringIntegration.alt}
                  width={mediaAssets.engineeringIntegration.width}
                  height={mediaAssets.engineeringIntegration.height}
                  priority
